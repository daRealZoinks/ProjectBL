...
namespace LocalPlayer
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        private void Floating()
        {
            ...
            var rayDidHit = Physics.Raycast(ray, out RaycastHit hitInfo, rayLength, groundLayerMask);
            ...
            {
                OnLand?.Invoke(_rigidbody.velocity.y);
            }
